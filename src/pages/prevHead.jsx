...
export default function Header() {
  ...
  return (
    <div>
      <header className='flex py-2 px-6 sm:px-6 justify-between place-items-center bg-gray-900 text-white'>

        <Link to={'/'} className="flex item-center ">
          <img src="../src/assets/logo.png" alt="" className='w-26 h-28' />
        </Link>
        <div className='flex bg-gray-800 rounded-md py-2.5 px-4 w-1/3 gap-4 items-center shadow-md'>
          ...
          <div ref={searchInputRef}>
            <input type="text" placeholder="Search" value={searchQuery} onChange={handleSearchInputChange} className='text-lg text-white outline-none w-full bg-gray-800 ' />
          </div>
        ...
        <Link to={'/createEvent'}> {/*TODO:Route create event page after creating it */}
          <div className='hidden md:flex flex-col place-items-center py-1 px-2 rounded text-white cursor-pointer hover:text-white hover:bg-gray-700 hover:shadow-sm shadow-gray-200 hover:transition-shadow duration-1500'>
            <button>
        ...
        <div className='hidden lg:flex gap-5 text-sm'>
          <Link to={'/checkrole'}> {/*TODO:Route wallet page after creating it */}
            <div className='flex flex-col place-items-center py-1 px-3 rounded cursor-pointer hover:text-white hover:bg-gray-700 shadow-gray-200 hover:transition-shadow duration-1500'>
          ...
          <Link to={'/calendar'}> {/*TODO:Route calendar page after creating it */}
            <div className='flex flex-col place-items-center py-1 px-3 rounded cursor-pointer hover:text-white hover:bg-gray-700 duration-1500'>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 py-1">
        ...
        <div>
          <div className='flex flex-col place-items-center py-1 px-3 rounded cursor-pointer hover:text-white hover:bg-gray-700'>
        ...
        {!!user && (
          ...
          <div className="flex flex-row items-center gap-2 sm:gap-8 ">
            ...
            <div className="hidden md:flex">
              <button onClick={logout} className="md:flex items-center gap-2 bg-gray-600 h-10 w-auto p-2 rounded-md text-white">
                <div>Log out</div>
                <RxExit />
              </button>
            </div>
        ...
        {!!user && (
          ...
          <div className="absolute z-10 mt-64 flex flex-col w-48 bg-black right-2 md:right-[160px] rounded-lg shadow-lg">
            {/* TODO: */}
            <nav className={`block ${isMenuOpen ? 'block' : 'hidden'} `}>
              <div className="flex flex-col font-semibold text-[16px]">
                <Link className="flex hover:bg-gray-700 hover:shadow py-2 pt-3 pl-6 pr-8 rounded-lg" to={'/createEvent'} >
                  Create Event
                </Link>

                <Link className="flex hover:bg-gray-700 hover:shadow py-2 pl-6 pr-8 rounded-lg" to={'/wallet'}>
                  <div>Wallet</div>
                </Link>

                <Link className="flex hover:bg-gray-700 hover:shadow py-2 pl-6 pr-8 rounded-lg" to={'/verification'}>
                  <div>Center</div>
                </Link>

                <Link className="flex hover:bg-gray-700 hover:shadow py-2 pl-6 pr-8 rounded-lg" to={'/calendar'}>
                  <div>Calendar</div>
                </Link>

                <Link className="flex hover:bg-gray-700 hover:shadow py-2 pl-6 pb-3 pr-8 rounded-lg" onClick={logout}>
                  Log out
                </Link>
              </div>
            </nav>
